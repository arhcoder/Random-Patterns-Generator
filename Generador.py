...
def generar_pattern(Chess_Piece, movimientos):
    ...
    while paso <= movimientos:
        ...
        if avance_xy[0] == 0 and avance_xy[1] == 0:
            ...
            pieza.mover(x, y, nueva_x, nueva_y)
            posiciones.append((nueva_x, nueva_y))
...
if __name__ == "__main__":
    ...
    print("\nPatrón de Torre:\n", generar_pattern(Rook_Pattern, movimientos))
    ...
    print("\nPatrón de Alfil:\n", generar_pattern(Bishop_Pattern, movimientos))
    ...
    print("\nPatrón de Reina:\n", generar_pattern(Queen_Pattern, movimientos))
